...
import more.education.bank.v2.service.FileBasedMonitoringService;
import more.education.bank.v2.service.InMemoryMonitoringServiceImpl;
...
public class BankApp {
    public static void main(String[] args) {
        ...
        MonitoringService monitoringService = !(System.getenv("monitoringStorage").equals("FILE")) ? new InMemoryMonitoringServiceImpl() : new FileBasedMonitoringService();
